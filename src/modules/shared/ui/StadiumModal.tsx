...
export default function StadiumModal({ facilityId, isOpen, onClose }: StadiumModalProps) {
  ...
  // Загружаем данные при изменении facilityId и isOpen
          ...
          <div>
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                {facility.type && <p className="text-xs text-gray-500 mt-0.5">{facility.type}</p>}
              </div>
            </div>
            ...
            {hasCoordinates && (
              <div className="mt-6">
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-[#ee862c] px-4 py-2 text-xs font-bold uppercase tracking-wider text-white hover:bg-[#f0ac74] transition-colors"
                >
                  Открыть на карте
                </a>
              </div>
