// Version Base — таймер Jersey 10 Charted
'use client';
  ...
  if (!mounted || !timeLeft) {
    return (
      <div className="text-center">
        <span className="text-lg text-gray-400">╨б╨║╨╛╤А╨╛</span>
      </div>
    );
  }

  const items = [
    { value: timeLeft.days, label: '╨Ф╨╜╨╡╨╣' },
    { value: timeLeft.hours, label: '╨з╨░╤Б╨╛╨▓' },
    { value: timeLeft.minutes, label: '╨Ь╨╕╨╜╤Г╤В' },
    { value: timeLeft.seconds, label: '╨б╨╡╨║╤Г╨╜╨┤' },
  ];
