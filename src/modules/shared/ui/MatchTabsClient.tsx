    ...
    >
      ...
      <div className="match__card-header relative z-10 grid grid-cols-[1fr_1fr] items-start gap-4">
        <div>
          ...
          {match.round && (
            <p className="mt-1 text-sm font-medium text-white/60">{match.round} тур</p>
          )}
        </div>
        <p className="flex items-center gap-2 text-right text-sm text-white/70 justify-end">
      ...
      <div className="mt-auto">
        ...
        <div className="mt-4 space-y-2">
          <div className="flex items-center justify-between">
            ...
            {isNext ? (
              <button className="inline-flex items-center gap-2 bg-[#ee862c] px-5 py-3 text-xs font-bold uppercase tracking-wider text-white hover:bg-[#f0ac74] transition-colors">
                БИЛЕТЫ <FontAwesomeIcon icon={faArrowRight} className="text-[10px]" />
              </button>
            ) : (
              <button className="inline-flex items-center gap-2 border border-white/20 px-5 py-3 text-xs font-bold uppercase tracking-wider text-white hover:border-[#ee862c] hover:text-[#ee862c] transition-colors">
...
function EmptyCard({ message }: { message: string }) {
  return (
    <div className="match__card relative flex w-full h-full flex-col border border-white/10 bg-white/5 backdrop-blur-xl shadow-2xl p-10 md:p-14 items-center justify-center">
