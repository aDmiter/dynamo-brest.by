...
const defaultSlides: FeaturedNews[] = [
  {
    id: '1',
...
function HeroSlideBody({ slide }: { slide: FeaturedNews }) {
  return (
        ...
        >
          {slides.map((slide) => (
            <SwiperSlide key={slide.id}>
              <HeroSlideBody slide={slide} />
            </SwiperSlide>
          ))}
        </Swiper>
      ) : (
        <div className="hero__swiper h-full w-full">
          <HeroSlideBody slide={slides[0]} />
        </div>
      )}
